        ...
        <sf:form action="orderStatus" name='form' modelAttribute="cake" method="POST">
            ...
            <div class="cont_order">
               <fieldset>
                ...
                <!-- this flavorList is taken dynamically by @ModelAttribute in controller -->
                ...
                <p>
                	<label class="inlinelabel" for='includeIncreption'>Include Inscription($5)</label>
                	<sf:checkbox path="includeIncreption" id="includeIncreption" value="5" />
                	<sf:input path="theIncreption" id="theIncreption" value="Enter Inscription" />
                </p>
                </fieldset>
            </div>
